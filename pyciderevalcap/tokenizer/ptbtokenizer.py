    ...
    def tokenize(self, captions_for_image):
        ...
        if self.source == 'gts':
            for k, line in zip(image_id, lines):
                ...
                tokenized_caption = ' '.encode('ascii').join([w for w in line.rstrip().split(' '.encode('ascii')) \
